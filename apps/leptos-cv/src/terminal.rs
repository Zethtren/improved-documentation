        ...
        "bat" | "cat" => {
            ...
            match *file {
                ...
                "experience/nicular.md" | "nicular.md" => bat_output("experience/nicular.md", &[
                    ...
                    "> Jul 2022 — Present",
                    "",
                    "I own the cloud. Designed and built the company's entire",
                    "GCP architecture from the ground up — VPCs, secrets",
                    "management, client storage, the works.",
                    "",
                    "Built internal tooling so the team can ship new services",
                    "to Cloud Run or GKE without touching infrastructure.",
                    "Led the migration of legacy GCP-managed apps into",
                    "Kubernetes, and I review every line of code that goes",
                    "to production.",
                ]),
